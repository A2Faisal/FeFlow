...
for year in year_list:
    ...
    fn.plot_network_map(title="Fe Production to In-use", radius=3, color="orangered", bins=[0, 15, 30, 60, 100, np.inf], labels=['<15', '15–30', '30–60', '60–100', '>100'], coverage=0.8, edge_alpha=0.3, edge_cmap="magma", steps=20, output_dir=plot_path, filename=f"network_map_s2_{year}_cp8_ap3_orangered.png", central_longitude=163)